...
export const INITIAL_SUBCATEGORIES: Subcategory[] = [
  ...
  {
    id: 'sub-men-underwear',
    categoryId: 'cat-men',
    name: 'Underwear',
    slug: 'underwear',
    description: 'Combed cotton briefs and boxers engineered for everyday support.',
    isActive: true,
    displayOrder: 2,
    productCount: 0,
  },
  {
    ...
    name: 'Socks',
    slug: 'socks',
    description: 'Cushioned and breathable pure cotton socks for all footwear.',
    isActive: true,
    displayOrder: 3,
    productCount: 0,
  },
  {
    ...
    name: 'Thermals',
    slug: 'thermals',
    description: 'Winter thermal tops and bottoms with heat-retaining rib knit.',
    isActive: true,
    displayOrder: 4,
    productCount: 0,
  },
  {
    ...
    name: 'T-Shirts',
    slug: 't-shirts',
    description: 'Classic crew-neck and V-neck daily undershirts and tees.',
    isActive: true,
    displayOrder: 5,
    productCount: 0,
  },
  ...
  // Women's Subcategories
  {
    ...
    name: 'Camisoles',
    slug: 'camisoles',
    description: 'Fine cotton undershirts and breathable daily camisoles.',
    isActive: true,
    displayOrder: 1,
    productCount: 0,
  },
  {
    ...
    name: 'Socks',
    slug: 'socks',
    description: 'Comfortable everyday and ankle cotton socks for women.',
    isActive: true,
    displayOrder: 2,
    productCount: 0,
  },
  {
    ...
    description: 'Stretch cotton inner leggings and opaque tights.',
    isActive: true,
    displayOrder: 3,
    productCount: 0,
  },
  {
    id: 'sub-women-thermals',
    categoryId: 'cat-women',
    name: 'Thermals',
    slug: 'thermals',
    description: 'Fleece-lined lightweight warmth thermals for winter layering.',
    isActive: true,
    displayOrder: 4,
    productCount: 0,
  },
  ...
  // Kids' Subcategories
  {
    ...
    name: 'Vests',
    slug: 'vests',
    description: 'Hypoallergenic soft combed cotton vests for boys and girls.',
    isActive: true,
    displayOrder: 1,
    productCount: 0,
  },
...
export const INITIAL_PRODUCTS: Product[] = [
  // Product 1: High Quality Vest (Taped Seams)
  {
    ...
    shippingInfo:
      'Fast delivery across all cities of Pakistan. Minimum order 1 piece. Orders of 3 or more pieces qualify for 100% Free Delivery. Cash on Delivery (COD) & Bank Transfer available.',
    isPublished: true,
